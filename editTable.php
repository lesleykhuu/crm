<?php
	...
	if(isset($_SESSION['removeField'])) {
		$a = "<div id='editTableFields' class='width50 hidden1'>";
		...
		$a = "<div id='editTableFields' class='width50'>";
	...
	$(document).ready(function(){
    	...
    	$("button.addField").click(function(){
    		...
    		document.getElementsByClassName("removeField").disabled = false;
       		...
       		$("#editTableFields").addClass("visible1");
    	...
    	$("button.removeField").click(function(){
    		...
    		document.getElementsByClassName("addField").disabled = false;
       		...
       		$("#editTableFields").addClass("hidden1");
       		$("#editTableFields").removeClass("visible1");
...
<!-- 		<div id="editTableFields" class="form-group">
		<div id="editTableFields" class="form-group hidden1"> -->
		<?php echo $a ?>
